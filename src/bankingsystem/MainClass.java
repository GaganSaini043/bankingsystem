...
public class MainClass extends CreateAccountModel {
	...
	// constructor
	public MainClass(String fName, String lName, String email, long phone, long accountNo, int pin, String accountType,
	...
	// method to select the option from banking service and transaction
	...
	public static void bankingService() throws IOException {
		...
		do {
			...
			if (pin == confirmPin) {
				...
				if (!compareAccount(accountNo)) {
					...
					CreateAccountModel ca = new CreateAccountModel(firstName, lastName, email, phone, accountNo, pin,
	...
	public static void editDetails() throws IOException {
				...
				if (createAcc.get(i).accountNo == accountNo) {
					...
					if (createAcc.get(i).pin == pin) {
						...
						do {
							...
							// switch case to perform edit according to the value entered by the user
							switch (sc.nextInt()) {
							case 1:
						...
						if (createAcc.get(i).pin == pin) {
							...
							do {
								...
								case 1:
									System.out.println("");
									System.out.println(
											"Your account balance is : " + createAcc.get(i).getAccountBalance());
								...
								case 2:
									System.out.println(
											"Your current account balance is :" + createAcc.get(i).getAccountBalance());
									System.out.println("Enter the amount you want to deposit :");
									double amount = sc.nextDouble();
									if (amount > 0) {
										createAcc.get(i).setAccountBalance(amount);
										System.out.println(
												"Your new account balance is :" + createAcc.get(i).getAccountBalance());
									...
									if (withdrawAmount > 0) {
										if (createAcc.get(i).getAccountBalance() > withdrawAmount) {
											...
											System.out.println("Your new account balance is :"
													+ createAcc.get(i).getAccountBalance());
										} else {
								...
								case 4:
									...
									if (transMoney > 0) {
                                                                                if(transMoney < createAcc.get(i).getAccountBalance()){
